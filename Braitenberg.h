...
private:
    ...
    float centerWeight = 0.45; // Weight for adjusting the importance of the blob being centered 0,45
    float distWeight = 0.2;   // Weight for adjusting the importance of the distance to the blob 0,2
    int turn_tic = 3780;
